...
import styles from "../css/footer.module.css"; // Đảm bảo bạn có file CSS phù hợp
    ...
    <footer className={styles.footer}>
      <div className={styles["footer-container"]}>
        ...
        <div className={styles["footer-col"]}>
          <img src="/img/logoXP.png" alt="MiMiBear Logo" className={styles["footer-logo"]} />
          <p>
        ...
        <div className={styles["footer-col"]}>
          ...
          <div className={styles["social-icons"]}>
            ...
            <a href="#"><img src="/img/iconzalo.png" alt="Zalo" /></a>
            <a href="#"><img src="/img/icontt.png" alt="TikTok" /></a>
            <a href="#"><img src="/img/iconyt.png" alt="YouTube" /></a>
          </div>
          <a href="#"><img src="https://kientrucxaydungtlt.com/images/bct.webp" alt="Đã thông báo Bộ Công Thương" className={styles["bct-logo"]} /></a>
        </div>
